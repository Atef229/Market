...
class GetOrderDataByUserId extends Component {
  ...
  componentDidMount() {
    axios.get('/api/order/' + this.props.match.params.owner_id)
      .then(res => {
        this.setState({
...
GetOrderDataByUserId.propTypes = {
...
export default connect(mapStateToProps, { getByuserId })(
  withRouter(GetOrderDataByUserId)
);
